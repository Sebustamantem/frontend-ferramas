                                ...
                                <div key={item.id} className="flex items-center gap-4 bg-gray-50 rounded-2xl p-4">
                                    {item.image_url ? (
                                        <img src={item.image_url} alt={item.name}
                                            className="w-16 h-16 object-contain bg-white rounded-xl border border-gray-200 p-1" />
                                    ) : (
                                        <div className="w-16 h-16 bg-gray-200 rounded-xl flex items-center justify-center text-gray-400 text-xs">
                                            Sin img
                                        </div>
                                    )}
